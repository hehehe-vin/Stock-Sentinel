      ...
      <div className="w-full max-w-md p-8 rounded-2xl shadow-xl transition-all"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-3 mt-4 rounded-lg font-medium text-sm transition-all duration-200 hover:opacity-90 disabled:opacity-50 flex justify-center items-center gap-2"
            style={{
          ...
          >
            {loading ? (
              <><div className="w-4 h-4 rounded-full border-2 border-white/30 border-t-white animate-spin"></div> Registering...</>
            ) : "Create Account"}
          </button>
        </form>
